...
IMAGES = {
    ...
    'spacetime': [
        ...
        ('light_bending.png', 'Light Bending (Gravitational Lensing)', 'Lichtablenkung (Gravitationslinse)',
         'Shows how gravity bends light rays and creates Einstein rings.',
         'Zeigt wie Gravitation Lichtstrahlen beugt und Einstein-Ringe erzeugt.'),
        ('penrose_schwarzschild.png', 'Penrose-Carter Diagram', 'Penrose-Carter-Diagramm',
         'Conformal spacetime diagram showing the causal structure of a black hole.',
         'Konformes Raumzeit-Diagramm, das die kausale Struktur eines Schwarzen Lochs zeigt.'),
        ('penrose_comparison.png', 'Penrose Diagram Comparison', 'Penrose-Diagramm-Vergleich',
         'Compares Minkowski, Schwarzschild, and stellar collapse spacetimes.',
         'Vergleicht Minkowski-, Schwarzschild- und Sternkollaps-Raumzeiten.'),
    ],
    'atoms': [
...
INTERACTIVE = [
    ...
    ('light_bending_3d_interactive.html', 'Light Bending 3D', 'Lichtablenkung 3D'),
]
    ...
    'spacetime': {
        'en': [
            ...
            {  # light_bending.png
                ...
                'formula': r'\alpha = \frac{4GM}{c^2 b}',
                'description': '''Light bends by angle α when passing at distance b from mass M. **Sun:** deflects starlight by 1.75 arcsec (confirmed by Eddington 1919!). **Einstein Ring:** θ_E = √(4GM·D_ls / c²·D_l·D_s) - forms when source, lens, and observer align perfectly.''',
            },
            {  # penrose_schwarzschild.png
                'title': 'Penrose-Carter Diagram',
                'formula': r'U = \sqrt{r/R_s - 1} \cdot e^{r/2R_s}, \quad T = \arctan(U+V) + \arctan(V-U)',
                'description': '''**Conformal diagram** compactifies infinite spacetime to finite size. Light always travels at 45°. **Regions:** I=exterior, II=inside horizon (future), III=other universe, IV=white hole (past). Singularity at r=0 is a **spacelike** boundary (unavoidable future).''',
            },
            {  # penrose_comparison.png
                'title': 'Spacetime Causal Structure',
                'formula': r'ds^2 = 0 \quad \text{(null geodesics at 45°)}',
                'description': '''**Minkowski:** flat, infinite, no horizons. **Schwarzschild:** eternal black hole with 4 regions, singularity is unavoidable. **Collapse:** realistic black hole formed from star - no white hole region. Penrose diagrams reveal the **causal structure** of spacetime!''',
            },
        ],
        'de': [
            {  # potential_well_2d.png
            ...
            {  # light_bending.png
                'title': 'Lichtablenkungswinkel',
                'formula': r'\alpha = \frac{4GM}{c^2 b}',
                'description': '''Licht wird um Winkel α gebeugt wenn es im Abstand b an Masse M vorbeigeht. **Sonne:** lenkt Sternlicht um 1,75 Bogensekunden ab (bestätigt durch Eddington 1919!). **Einstein-Ring:** θ_E = √(4GM·D_ls / c²·D_l·D_s) - entsteht bei perfekter Ausrichtung von Quelle, Linse und Beobachter.''',
            },
            {  # penrose_schwarzschild.png
                'title': 'Penrose-Carter-Diagramm',
                'formula': r'U = \sqrt{r/R_s - 1} \cdot e^{r/2R_s}, \quad T = \arctan(U+V) + \arctan(V-U)',
                'description': '''**Konformes Diagramm** kompaktifiziert unendliche Raumzeit auf endliche Größe. Licht bewegt sich immer auf 45°-Linien. **Regionen:** I=außen, II=innerhalb des Horizonts (Zukunft), III=anderes Universum, IV=Weißes Loch (Vergangenheit). Singularität bei r=0 ist eine **raumartige** Grenze (unvermeidliche Zukunft).''',
            },
            {  # penrose_comparison.png
                'title': 'Kausale Struktur der Raumzeit',
                'formula': r'ds^2 = 0 \quad \text{(Nullgeodäten bei 45°)}',
                'description': '''**Minkowski:** flach, unendlich, keine Horizonte. **Schwarzschild:** ewiges Schwarzes Loch mit 4 Regionen, Singularität unvermeidbar. **Kollaps:** realistisches Schwarzes Loch aus Stern gebildet - keine Weiße-Loch-Region. Penrose-Diagramme enthüllen die **kausale Struktur** der Raumzeit!''',
            },
        ],
    },
    'atoms': {
